...
class Person:
    ...
    def __repr__(self):
        return str(self.name) + str(self.cur_pos) + str(self.dst_pos)
...
if __name__ == "__main__":
    ...
    for name in namelist:
        cur = get_random_point(
            0, factory_size.x - 1, 0, factory_size.y - 1, 0, factory_size.z - 1
        )
        dst = get_random_point(
            0, factory_size.x - 1, 0, factory_size.y - 1, 0, factory_size.z - 1
        )
