...
class Bubbles:
    bubble = pygame.image.load(image_path + "/b1.png")
    bubble_pop = [
        pygame.image.load(image_path + "/b%s.png" % img) for img in range(2, 8)
    ]
    bubble_array = []
    ...
    def add_word_bubble(game, word, screen):
        ...
        Bubbles.bubble_array.append(Bubbles(game, True, word.x, y_offset))
        return
