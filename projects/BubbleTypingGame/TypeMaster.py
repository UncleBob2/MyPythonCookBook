...
class Game:
    def __init__(self):
        ...
        self.word_delay_high_cap = 0.25
        self.max_word_speed = 1
        self.text_blink_delay = 0.5
        self.player_score = 0
        ...
        # HUD Variables
        self.left_corner_x_offset = 0.15
        self.right_corner_x_offset = 0.85
        self.bubble_y_offset = 0.42
        self.input_width = 0
        ...
        self.game_button_right = pygame.image.load(
            "Media/bubbles/game_button_right.png"
        )
    ...
    def set_game_speed_up(self):
        ...
        elif self.add_word_delay == 0.25:
            pass
        else:
            self.add_word_delay -= 0.25
        ...
        if self.word_delay_score_multiplier == 6.0:
            ...
            self.word_delay_score_multiplier += 0.1
    ...
    def set_game_speed_down(self):
        ...
        if self.word_delay_score_multiplier == 0.3:
            pass
        elif self.word_delay_score_multiplier <= 1.0:
            self.word_delay_score_multiplier -= 0.1
        else:
